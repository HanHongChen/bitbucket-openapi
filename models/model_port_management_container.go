...
type PortManagementContainer struct {
	...
	PortManCont string `json:"portManCont" yaml:"portManCont" bson:"portManCont" mapstructure:"PortManCont"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	PortNum int32 `json:"portNum" yaml:"portNum" bson:"portNum" mapstructure:"PortNum"`
}
