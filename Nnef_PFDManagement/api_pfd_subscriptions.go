...
func (a *PFDSubscriptionsApiService) NnefPFDmanagementSubscribe(ctx context.Context, pfdSubscription models.PfdSubscription) (models.PfdSubscription, *http.Response, error) {
	...
	case 503:
		...
		return localVarReturnValue, localVarHTTPResponse, apiError
	default:
		return localVarReturnValue, localVarHTTPResponse, common.ReportError("%d is not a valid status code in NnefPFDmanagementSubscribe", localVarHTTPResponse.StatusCode)
	}
}
